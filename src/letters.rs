use ratatui::{ style::Color, widgets::canvas::{ Line, Painter, Shape } };
...
impl Letter {
    pub fn new_letter(letter: char, starting_x: f64) -> Self {
        let lines = match letter {
            ...
            // F
            'f' =>
                vec![vec![0.0, 5.0, 0.0, 0.0], vec![0.0, 5.0, 4.0, 5.0], vec![0.0, 2.5, 3.0, 2.5]],
            // G
            'g' =>
                vec![
                    vec![4.0, 5.0, 1.0, 5.0],
            ...
            // H
            'h' =>
                vec![vec![0.0, 0.0, 0.0, 5.0], vec![0.0, 2.5, 4.0, 2.5], vec![4.0, 0.0, 4.0, 5.0]],
            // I
            'i' =>
                vec![vec![1.0, 5.0, 4.0, 5.0], vec![2.5, 5.0, 2.5, 0.0], vec![1.0, 0.0, 4.0, 0.0]],
            // J
            'j' =>
                vec![
                    vec![1.0, 5.0, 4.0, 5.0],
            ...
            // K
            'k' =>
                vec![vec![0.0, 0.0, 0.0, 5.0], vec![0.0, 2.5, 4.0, 5.0], vec![0.0, 2.5, 4.0, 0.0]],
            // L
            ...
            // N
            'n' =>
                vec![vec![0.0, 0.0, 0.0, 5.0], vec![0.0, 5.0, 5.0, 0.0], vec![5.0, 0.0, 5.0, 5.0]],
            // O
            'o' =>
                vec![
                    vec![1.0, 5.0, 4.0, 5.0],
            ...
            // Y
            'y' =>
                vec![vec![0.0, 5.0, 2.5, 2.5], vec![5.0, 5.0, 2.5, 2.5], vec![2.5, 2.5, 2.5, 0.0]],
            // Z
            'z' =>
                vec![vec![0.0, 5.0, 5.0, 5.0], vec![5.0, 5.0, 0.0, 0.0], vec![0.0, 0.0, 5.0, 0.0]],
            // Space
            ' ' => vec![],
